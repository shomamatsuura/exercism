...
int monthly_rate(double hourly_rate, double discount) {
    ...
    int monthly_rate_discount = (int)ceil(apply_discount(monthly_rate_before_discount, discount));
    return monthly_rate_discount;
}
...
int days_in_budget(int budget, double hourly_rate, double discount) {
    ...
    int result = (int)floor(budget / apply_discount(daily_rate(hourly_rate), discount));
    return result;
}
